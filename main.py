...
bot = telebot.TeleBot('6665127905:AAG62IVk8IOa2GOhmD-yPVO4GaPrjycJFlw')
...
🚀 Buy From :- @NotNagru 
🚀 Official Channel :- https://t.me/NotNagruDdos
'''
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to The Bot, NotNagru 💖
